        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="inline-block mb-4">
              {logoUrl ? (
                <>
                  <img src={logoUrl} alt="Tata Warga Logo" className={`h-8 w-auto ${logoUrlDark ? "dark:hidden" : ""}`} />
                  {logoUrlDark && <img src={logoUrlDark} alt="Tata Warga Logo" className="h-8 w-auto hidden dark:block" />}
                </>
              ) : (
