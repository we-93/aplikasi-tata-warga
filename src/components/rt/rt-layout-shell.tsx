  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-black font-sans text-slate-900 dark:text-slate-100 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col w-full h-full overflow-hidden relative z-0 md:pl-0">
        ...
        {/* Header */}
        <header className="h-20 bg-white/80 dark:bg-[#141229]/80 backdrop-blur-md border-b border-slate-200 dark:border-white/10 flex items-center justify-between px-4 md:px-6 sticky top-0 z-20">
