          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
              <Link href="#harga" className="w-full sm:w-auto">
                <Button size="lg" variant="secondary" className="w-full text-primary font-semibold group">
                  Coba Gratis Sekarang
                  <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                </Button>
              </Link>
              <Link href="https://api.whatsapp.com/send?phone=6285945441445&text=Halo%20admin%2C%20saya%20ingin%20informasi%20terkait%20Tata%20Warga...." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <Button size="lg" className="w-full font-semibold bg-[#1e1b38] hover:bg-[#1e1b38]/90 text-white border-0">
